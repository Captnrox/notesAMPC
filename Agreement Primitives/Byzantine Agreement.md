...
# How it works
---
1.  Commander phase - Designate a commander using [commander selection protocols](../Others/Commander%20Selection.md) that broadcasts their value to all other processes.
